    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            categor("https://godomicilios.co/webService/servicios.php?svice=CATALOGOS&metodo=json&lat="
                    +settings.order.getLatitude()+"&long="+settings.order.getLongitude()+"&tipo_empresa=4",4);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        settings.user.setGoogleApiClient(new GoogleApiClient.Builder(this)
                ...
                .build());
        settings.order.setReloadActivity(4);
        ...
        pharmacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFour.this, headThree.class);
                startActivity(go);
                    ...
                    public void onResponse(JSONArray response) {
                        try{
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                settings.stablishment.stablishments.add(new stablishment(4,i+1,
                                ...
                                one.setImageDrawable(getResources().getDrawable(R.drawable.estrellaverdevacia));
                                two.setImageDrawable(getResources().getDrawable(R.drawable.estrellaverdevacia));
                                three.setImageDrawable(getResources().getDrawable(R.drawable.estrellaverdevacia));
                                four.setImageDrawable(getResources().getDrawable(R.drawable.estrellaverdevacia));
                                five.setImageDrawable(getResources().getDrawable(R.drawable.estrellaverdevacia));

...
import godomicilios.mdcc.pulpapp.adapter.chatAdapter;
import godomicilios.mdcc.pulpapp.settings.CustomSSLSocketFactory;
import godomicilios.mdcc.pulpapp.settings.StationBuss;
import godomicilios.mdcc.pulpapp.settings.arrayChat;
import godomicilios.mdcc.pulpapp.settings.chats;
import godomicilios.mdcc.pulpapp.settings.settings;
import godomicilios.mdcc.pulpapp.settings.updateChat;
...
public class chat extends AppCompatActivity {
 ...
 /*       try {
    ...
    public void onBackPressed() {
        this.finish();
        Intent intent = new Intent(chat.this, status.class);

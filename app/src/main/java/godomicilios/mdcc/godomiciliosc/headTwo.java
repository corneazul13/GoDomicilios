    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two_select));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                try {
        ...
        prices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two_select));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                try {
        ...
        methodPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two_select));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
            }
        });
        ...
        promotions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_two_select));
                try {
                    ...
                    public void onResponse(JSONArray response) {
                        try{
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                settings.stablishment.stablishments.add(new stablishment(2,
                               ...
                               /* new settings.DownloadImageTask(im)
                                        .execute("https://godomicilios.co/admin/documentosVarios/"+address.getString("imagen_corporativa"));
*/
                                if(i%2==0){
...
//                            in = new ArrayList<>();
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                View childaa = View.inflate(headTwo.this, R.layout.rank, null);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(final JSONArray response) {
                        try{
                            ...
                            Intent go = new Intent(headTwo.this, clas);
                            startActivity(go);
                            headTwo.this.finish();
                        }
                        catch (Exception e){

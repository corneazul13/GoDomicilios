...
public class headFive extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_five);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five_select));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                try {
                    httpC("https://godomicilios.co/webService/servicios.php?svice=FILTRO_MEJOR_TIEMPO&metodo=json&lat="
                            +settings.order.getLatitude()+"&long="+settings.order.getLongitude()+"&tipo_empresa=5");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        prices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five_select));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                try {
        ...
        methodPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five_select));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
            }
        });
        ...
        promotions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_five_select));
                try {
        ...
        pharmacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFive.this, headThree.class);
                startActivity(go);
        ...
        pet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFive.this, headFour.class);
                startActivity(go);
        ...
        food.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFive.this, head.class);
                startActivity(go);
        ...
        beer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFive.this, headTwo.class);
                startActivity(go);
    ...
    public void onBackPressed() {
        Intent go = new Intent(headFive.this, choose.class);
        startActivity(go);
        this.finish();
    }
...
*/
        ...
        switch (item.getItemId()) {
            case R.id.car:
                ...
                if(settings.shoppingCar.carFinal.size()>0){
                    Intent go = new Intent(headFive.this, car.class);
                    startActivity(go);
                }
                else{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.porfile) {
            Intent go = new Intent(headFive.this,porfile.class);
            startActivity(go);

        } else if (id == R.id.referred) {
            Intent go = new Intent(headFive.this,refer.class);
            startActivity(go);

        } else if (id == R.id.coupons) {
            Intent go = new Intent(headFive.this,coupons.class);
            startActivity(go);
            ...
            Intent go = new Intent(headFive.this,payM.class);
            startActivity(go);
    ...
    public void httpC (String url) throws Exception{
        ...
        final RequestQueue queue = Volley.newRequestQueue(this,new HurlStack(
                null, CustomSSLSocketFactory.getSSLSocketFactory(headFive.this)));


        final ProgressDialog dialog = ProgressDialog.show(headFive.this, "",
                    ...
                    public void onResponse(JSONArray response) {
                        try{
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                View child = View.inflate(headFive.this, R.layout.li, null);
                                ...
                                one.setImageDrawable(getResources().getDrawable(R.drawable.estrellaamarillavacia));
                                two.setImageDrawable(getResources().getDrawable(R.drawable.estrellaamarillavacia));
                                three.setImageDrawable(getResources().getDrawable(R.drawable.estrellaamarillavacia));
                                four.setImageDrawable(getResources().getDrawable(R.drawable.estrellaamarillavacia));
                                five.setImageDrawable(getResources().getDrawable(R.drawable.estrellaamarillavacia));
                                name.setTextColor(getResources().getColor(R.color.yellowmarket));
                                d.setBackgroundColor(getResources().getColor(R.color.yellowmarket));
...
//                            in = new ArrayList<>();
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                View childaa = View.inflate(headFive.this, R.layout.rank, null);
                                        ...
                                        public void onResponse(JSONArray response) {
                                            try{
                                                for(int i = 0; i<response.length(); i++) {
                                                    ...
                                                    Integer modifi = product.getInt("bebida_modificable");
                                                ...
                                                Intent go = new Intent(headFive.this, stablishm.class);
                                                startActivity(go);
    ...
    public void stars (Integer i, ImageView one, ImageView two, ImageView three,
        ...
        switch (i){
            case 1:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillamitad));
                break;
            case 2:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                break;
            case 3:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillamitad));
                break;
            case 4:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                break;
            case 5:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillamitad));
                break;
            case 6:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                break;
            case 7:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillamitad));
                break;
            case 8:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                break;
            case 9:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                five.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillamitad));
                break;
            case 10:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                five.setImageDrawable(getResources().getDrawable(R.drawable.medianaamarillacompleta));
                break;
        }
    }
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(final JSONArray response) {
                        try{
                            ...
                            Intent go = new Intent(headFive.this, clas);
                            startActivity(go);
                            headFive.this.finish();
                        }
                        catch (Exception e){
                        }
    ...
    public void addItemsOnSpinner2() {
        ...
        catego.setOnItemSelectedListener(new headFive.addressSpinnerClassOne());
    }
            ...
            if (settings.categories.get(position)=="CATEGORIA")
            {
                ...
                try {
                    categorSpinner("https://godomicilios.co/webService/servicios.php?svice=FILTRO_CATEGORIA&metodo=json&lat="
                            ...
                            "&tipo_empresa=5&categoria="+settings.categories.get(position).replace(" ","%20")
                    );
                } catch (Exception e) {
                    e.printStackTrace();
                }

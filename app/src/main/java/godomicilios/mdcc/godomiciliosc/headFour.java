...
public class headFour extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_four);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four_select));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                try {
                    httpC("https://godomicilios.co/webService/servicios.php?svice=FILTRO_MEJOR_TIEMPO&metodo=json&lat="
                            +settings.order.getLatitude()+"&long="+settings.order.getLongitude()+"&tipo_empresa=4");
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        prices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four_select));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                try {
        ...
        methodPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                time.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four_select));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
            }
        });
        ...
        promotions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prices.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                methodPay.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four));
                promotions.setBackgroundDrawable(getResources().getDrawable(R.drawable.corners_four_select));
                try {
        ...
        pharmacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFour.this, headFour.class);
                startActivity(go);
        ...
        food.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFour.this, head.class);
                startActivity(go);
        ...
        market.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFour.this, headFive.class);
                startActivity(go);
        ...
        beer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent go = new Intent(headFour.this, headTwo.class);
                startActivity(go);
        ...
        try {
            httpC("https://godomicilios.co/webService/servicios.php?svice=EMPRESAS&metodo=json&lat="+ settings.order.getLatitude()+"&long="+settings.order.getLongitude()+"&tipo_empresa=4");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onBackPressed() {
        Intent go = new Intent(headFour.this, choose.class);
        startActivity(go);
        this.finish();
    }
        ...
        switch (item.getItemId()) {
            case R.id.car:
                ...
                if(settings.shoppingCar.carFinal.size()>0){
                    Intent go = new Intent(headFour.this, car.class);
                    startActivity(go);
                }
                else{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.porfile) {
            Intent go = new Intent(headFour.this,porfile.class);
            startActivity(go);

        } else if (id == R.id.referred) {
            Intent go = new Intent(headFour.this,refer.class);
            startActivity(go);

        } else if (id == R.id.coupons) {
            Intent go = new Intent(headFour.this,coupons.class);
            startActivity(go);
            ...
            Intent go = new Intent(headFour.this,payM.class);
            startActivity(go);
    ...
    public void httpC (String url) throws Exception{
        ...
        final RequestQueue queue = Volley.newRequestQueue(this, new HurlStack(
                null, CustomSSLSocketFactory.getSSLSocketFactory(headFour.this)));

        final ProgressDialog dialog = ProgressDialog.show(headFour.this, "",
                    ...
                    public void onResponse(JSONArray response) {
                        try{
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                settings.stablishment.stablishments.add(new stablishment(4,
                                ...
                                one.setImageDrawable(getResources().getDrawable(R.drawable.estrellaazulvacia));
                                two.setImageDrawable(getResources().getDrawable(R.drawable.estrellaazulvacia));
                                three.setImageDrawable(getResources().getDrawable(R.drawable.estrellaazulvacia));
                                four.setImageDrawable(getResources().getDrawable(R.drawable.estrellaazulvacia));
                                five.setImageDrawable(getResources().getDrawable(R.drawable.estrellaazulvacia));
                                name.setTextColor(getResources().getColor(R.color.bluePet));
                                d.setBackgroundColor(getResources().getColor(R.color.bluePet));
...
//                            in = new ArrayList<>();
                            ...
                            for(int i =0;i<response.length();i++) {
                                ...
                                View childaa = View.inflate(headFour.this, R.layout.rank, null);
                                    ...
                                    new Response.Listener<JSONArray>() {
                                        ...
                                        public void onResponse(JSONArray response) {
                                            try{
                                                ...
                                                Intent go = new Intent(headFour.this, stablishm.class);
                                                startActivity(go);
    ...
    public void stars (Integer i, ImageView one, ImageView two, ImageView three,
        ...
        switch (i){
            case 1:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulmitad));
                break;
            case 2:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                break;
            case 3:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulmitad));
                break;
            case 4:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                break;
            case 5:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulmitad));
                break;
            case 6:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                break;
            case 7:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulmitad));
                break;
            case 8:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                break;
            case 9:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                five.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulmitad));
                break;
            case 10:
                one.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                two.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                three.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                four.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                five.setImageDrawable(getResources().getDrawable(R.drawable.medianaazulcompleta));
                break;
        }
    }
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(final JSONArray response) {
                        try{
                            ...
                            Intent go = new Intent(headFour.this, clas);
                            startActivity(go);
                            headFour.this.finish();
                        }
                        catch (Exception e){
                        }
    ...
    public void addItemsOnSpinner2() {
        ...
        catego.setOnItemSelectedListener(new headFour.addressSpinnerClassOne());
    }
            ...
            if (settings.categories.get(position)=="CATEGORIA")
            {
                ...
                try {
                    categorSpinner("https://godomicilios.co/webService/servicios.php?svice=FILTRO_CATEGORIA&metodo=json&lat="
                            ...
                            "&tipo_empresa=4&categoria="+settings.categories.get(position).replace(" ","%20")
                    );
                } catch (Exception e) {
                    e.printStackTrace();
                }
